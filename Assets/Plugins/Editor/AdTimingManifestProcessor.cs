...
#if UNITY_2018_1_OR_NEWER
public class AdTimingManifestProcessor : IPreprocessBuildWithReport
#else
public class AdTimingManifestProcessor : IPreprocessBuild
#endif
{
...
#endif
    {
        if (AdTimingAdMobSettings.Instance.IsAdMobEnabled)
        {
            ...
            string appId = AdTimingAdMobSettings.Instance.AdMobAndroidAppId;
